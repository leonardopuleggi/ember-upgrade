...
import footerTemplate from 'composer-components/components/aupac-typeahead/footer';
import headerTemplate from 'composer-components/components/aupac-typeahead/header';
import notFoundTemplate from 'composer-components/components/aupac-typeahead/not-found';
import pendingTemplate from 'composer-components/components/aupac-typeahead/pending';
import suggestionTemplate from 'composer-components/components/aupac-typeahead/suggestion';
